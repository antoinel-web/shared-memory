---
agent: deal-pulse
run_at: 2026-05-12T07:37:00+02:00
status: success
version: 2.0
sources_read:
  - salesforce: 29 opportunities
  - google_calendar: 29 events (May 12–19, 2026)
  - granola: 63 meetings (last 30 days)
  - deal_pulse_rules: 7 active rules
  - deal_pulse_snapshots: 0 previous snapshots loaded
outputs_written:
  - /agent/home/deal_pulse_data.json: 29 deals (HOT:3 MED:9 COLD:17)
  - state/pipeline-state-latest.md: live pipeline state (GitHub)
  - state/current/pipeline-state-2026-05-12.md: dated snapshot (GitHub)
